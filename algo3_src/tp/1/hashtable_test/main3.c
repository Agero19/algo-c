...
static int scptr_display(context *ctx, const char *s, const char *cptr);
...
int scptr_display(context *ctx, const char *s, const char *cptr) {
  long int occ = cptr - ctx->compteur;
  if (occ > ctx->borne) {
